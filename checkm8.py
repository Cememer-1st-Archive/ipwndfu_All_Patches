...
def payload(cpid):
  ...
  if cpid == 0x8010:
    ...
    t8010_callbacks = [
      ...
      (t8010_tlbi, 0),
      (0x1820B0610, 0),
      (t8010_write_ttbr0, 0x1800A8000), # A custom pagetable we just set up https://github.com/Cryptiiiic/ipwndfu_public/commit/8c0f20d8a4085ea9bfdce59ec8a11330a959b5a2
      (t8010_tlbi, 0),
      (t8010_exit_critical_section, 0),
      (0x1800B0000, 0),
      (t8010_write_ttbr0, 0x1800A0000), # Real pagetable https://github.com/Cryptiiiic/ipwndfu_public/commit/8c0f20d8a4085ea9bfdce59ec8a11330a959b5a2
      (t8010_tlbi, 0),
    ]
